...
User.destroy_all
USER_TEST = User.create({ name: 'Test', currency: EUR, country: NL,
                   mobile: '0612345678', email: 'test@marketram.com',
                   password: 'password', password_confirmation: 'password' } )
USER_TEST.save!
USER_ADMIN = User.create({ name: 'Admin', currency: EUR, country: NL,
                           mobile: '0612345678', email: 'admin@marketram.com',
                           password: '123456', password_confirmation: '123456' } )
USER_ADMIN.save!
USER_EUGENE = User.create({ name: 'Eugene Markine', currency: USD, country: NL,
